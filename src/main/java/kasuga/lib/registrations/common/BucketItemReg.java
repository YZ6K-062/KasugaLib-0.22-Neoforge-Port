...
public class BucketItemReg<T extends BucketItem> extends ItemReg<T> {
    ...
    private Supplier<? extends BaseFlowingFluid> fluid = null;
    ...
    public static BucketItemReg<BucketItem> defaultBucketItem(FluidReg<?> fluidReg, @Nullable ResourceLocation model) {
        ...
        // 1.21: BucketItem takes a Fluid instance, not a Supplier, so the supplier is resolved here.
        reg.itemType((fluidSupplier, properties) -> new BucketItem(fluidSupplier.get(), properties));
     ...
     */
    @Mandatory
    public BucketItemReg<T> fluidType(Supplier<? extends BaseFlowingFluid> fluid) {
        this.fluid = fluid;
        return this;
    }
    ...
    public ItemReg<T> tab(CreativeTabReg tab) {
        // properties.tab() removed in 1.21.1
        return this;
    }
    ...
    public interface BucketBuilder<T extends BucketItem> {
        T build(Supplier<? extends BaseFlowingFluid> fluid, Item.Properties properties);
    }
}
