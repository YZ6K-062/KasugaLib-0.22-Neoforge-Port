...
public class ConfiguredFeatureReg<T extends Block> extends Reg {
    ...
    private DeferredHolder<ConfiguredFeature<?, ?>, ConfiguredFeature<?, ?>> registryObject = null;
    ...
    public ConfiguredFeatureReg<T> addOreConfigTargetByBlock(ResourceLocation block, Supplier<T> ore) {
        oreConfigTargetList.add(() -> {
            Block b = BuiltInRegistries.BLOCK.get(block);
    ...
    public DeferredHolder<ConfiguredFeature<?, ?>, ConfiguredFeature<?, ?>> getRegistryObject() {
