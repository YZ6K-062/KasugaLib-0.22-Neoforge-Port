...
public class EffectReg<T extends MobEffect> extends Reg {
    ...
    private DeferredHolder<MobEffect, T> registryObject = null;
     ...
     */
    @Mandatory
    public EffectReg<T> effectType(@NotNull EffectBuilder<? extends MobEffect> builder) {
    ...
    public DeferredHolder<MobEffect, T> getRegistryObject() {
