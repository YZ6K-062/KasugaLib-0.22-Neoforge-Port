...
public class FluidBlockReg<T extends LiquidBlock> extends Reg {
    ...
    private Supplier<? extends BaseFlowingFluid> fluid;
    private DeferredHolder<Block, T> registryObject;
     ...
     */
    @Mandatory
    public FluidBlockReg<T> fluid(Supplier<? extends BaseFlowingFluid> fluid) {
        this.fluid = fluid;
        return this;
    }
     ...
     */
    @Mandatory
    public FluidBlockReg<T> materialColor(MapColor color) {
        this.color = color;
        return this;
    }
    ...
    public DeferredHolder<Block, T> getRegistryObject() {
    ...
    public interface FluidBlockBuilder<T extends LiquidBlock> {
        T build(Supplier<? extends BaseFlowingFluid> fluid, BlockBehaviour.Properties properties);
    }
}
