...
public class BlockEntityReg<T extends BlockEntity> extends Reg {
    ...
    private DeferredHolder<BlockEntityType<?>, BlockEntityType<T>> registryObject;
     ...
     * registration object like BlockReg in Kasuga Reg or DeferredHolder in minecraftforge.
     ...
     * to get this. For more info, see {@link BlockReg#instance()} and {@link DeferredHolder#get()}
