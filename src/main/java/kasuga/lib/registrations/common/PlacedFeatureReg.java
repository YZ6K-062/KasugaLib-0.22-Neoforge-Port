...
public class PlacedFeatureReg extends Reg {
    ...
    private DeferredHolder<ConfiguredFeature<?, ?>, ConfiguredFeature<?, ?>> configuredFeatureObject = null;
    private HeightRangePlacement heightRangePlacement = null;
    private DeferredHolder<PlacedFeature, PlacedFeature> object = null;
    ...
    public PlacedFeatureReg setConfiguredFeatureObject(DeferredHolder<ConfiguredFeature<?, ?>, ConfiguredFeature<?, ?>> configuredFeature) {
    ...
    public PlacedFeatureReg submit(SimpleRegistry registry) {
        ...
        this.object = registry.placedFeature().register(
                registrationKey,
                () -> new PlacedFeature(
                        configuredFeatureObject,
                        commonOrePlacement(groupCountPerChunk, heightRangePlacement)));
        return this;
    }

    public @Nullable DeferredHolder<PlacedFeature, PlacedFeature> getRegisterObject() {
        return this.object;
    }
