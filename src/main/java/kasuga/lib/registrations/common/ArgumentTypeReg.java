...
public class ArgumentTypeReg extends Reg {
    ...
    static {
        ...
        // 1.21: the single-String ResourceLocation constructor is gone; use the parse() factory.
        ArgumentTypeReg.INSTANCE.registerType(ResourceLocation.class, ResourceLocation::parse);
