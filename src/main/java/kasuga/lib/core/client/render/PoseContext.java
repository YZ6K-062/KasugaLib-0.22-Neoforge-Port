...
public class PoseContext {
    ...
    public void rotateX(float x_rotation) {
        addAct(stack -> stack.mulPose(new Quaternionf().rotateX((float) Math.toRadians(x_rotation))));
    }

    public void rotateY(float y_rotation) {
        addAct(stack -> stack.mulPose(new Quaternionf().rotateY((float) Math.toRadians(y_rotation))));
    }

    public void rotateZ(float z_rotation) {
        addAct(stack -> stack.mulPose(new Quaternionf().rotateZ((float) Math.toRadians(z_rotation))));
    }
