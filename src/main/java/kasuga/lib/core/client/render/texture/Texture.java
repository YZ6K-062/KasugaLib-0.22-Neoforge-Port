...
public class Texture extends GraphicsImage<Texture> {
    ...
    public void render(float x, float y, float width, float height){
        ...
        buffer.addVertex(x, y, 0f).setUv(uOffsetUVCache, vOffsetUVCache);
        buffer.addVertex(x, y + height, 0f).setUv(uOffsetUVCache, vOffsetUVCache + vHeightUVCache);
        buffer.addVertex(x + width, y + height, 0f).setUv(uOffsetUVCache + uWidthUVCache, vOffsetUVCache + vHeightUVCache);
        buffer.addVertex(x + width, y, 0f).setUv(uOffsetUVCache + uWidthUVCache, vOffsetUVCache);
    ...
    protected void buildVertex(VertexConsumer consumer, Matrix4f matrix,
        ...
        // 1.21 renamed the vertex builder methods and dropped the explicit endVertex().
