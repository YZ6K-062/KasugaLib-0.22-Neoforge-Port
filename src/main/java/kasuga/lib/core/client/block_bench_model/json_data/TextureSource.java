...
public class TextureSource {
    ...
    public void registerTextureAs(ResourceLocation location) throws IOException {
        ...
        Minecraft.getInstance().getTextureManager().register(cheat.location(),
    ...
    public Material getAsMaterial(ResourceLocation atlas, ResourceLocation location) throws IOException {
        ...
        ResourceLocation rl = ResourceLocation.fromNamespaceAndPath(location.getNamespace(), "textures/" + location.getPath() + ".png");
