...
public class ModelTransform {
    ...
    public Quaternionf getQuaternion() {
        ...
        quaternion.mul(new Quaternionf().rotateZ((float) Math.toRadians(rotation.z())));
        quaternion.mul(new Quaternionf().rotateY((float) Math.toRadians(rotation.y())));
        quaternion.mul(new Quaternionf().rotateX((float) -Math.toRadians(rotation.x())));
        return quaternion;
        // return new Quaternionf().rotationXYZ((float) Math.toRadians(rotation.x()), (float) Math.toRadians(rotation.y()), (float) Math.toRadians(rotation.z()));
    }
