...
public class AnimBone implements BedrockRenderable, Animable {
    ...
    private void collectLocators() {
        ...
        Vector3f parentPivot = parent == null ? new Vector3f(0, 0, 0) : new Vector3f(parent.getPivot());
    ...
    public void initAnim() {
        ...
        this.animRot = new Vector3f(0, 0, 0);
    ...
    public void applyTranslationAndRotation(PoseStack pose) {
        ...
        Vector3f parentTrans = parent != null ? new Vector3f(parent.getPivot()) : new Vector3f(0, 0, 0);
