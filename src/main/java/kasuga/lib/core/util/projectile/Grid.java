...
public class Grid {
    ...
    public Ray getNormalRay(float x, float y) {
        ...
        return new Ray(source, new Vector3f((float) panel.normal.x(), (float) panel.normal.y(), (float) panel.normal.z()));
    }
    ...
    public static void main(String[] args) {
        ...
        Grid grid = new Grid(panel, new Vector3f(0, 0, 0), xo2f, yo2f);
        grid.rotDeg(80);
