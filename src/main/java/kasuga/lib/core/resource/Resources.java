...
public class Resources {
    ...
    public static final java.util.Set<ResourceLocation> CHEAT_TEXTURES = java.util.concurrent.ConcurrentHashMap.newKeySet();
    ...
    public static class CheatResourceLocation {
        ...
        public CheatResourceLocation(String pLocation) {
            this.location = ResourceLocation.parse(pLocation);
        }

        public CheatResourceLocation(String pNamespace, String pPath) {
            this.location = ResourceLocation.fromNamespaceAndPath(pNamespace, pPath);
        }
        ...
        public CheatResourceLocation clone() {
            return new CheatResourceLocation(location.getNamespace(), location.getPath(), isOutside);
        }
    ...
    public static void registerResource(String namespace, String name, Consumer<KasugaPackResource> registerFunc) {
        ...
        ResourceLocation rl = ResourceLocation.fromNamespaceAndPath(namespace, name);
