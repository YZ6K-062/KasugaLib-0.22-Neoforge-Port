...
public class BlockStateGenerator<T extends AbstractBogeyBlock<?>> {
    ...
    public BlockStateGenerator(DeferredHolder<Block, ? extends Block> registration) {
    ...
    public BlockStateGenerator<T> dropItem(DeferredHolder<ItemLike, ? extends ItemLike> reg) {
