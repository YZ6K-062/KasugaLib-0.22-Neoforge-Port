...
public class GreenAppleTileRenderer implements BlockEntityRenderer<GreenAppleTile> {
    ...
    // private static final WorldTexture texture = new WorldTexture(ResourceLocation.fromNamespaceAndPath(KasugaLib.MOD_ID, "textures/common/test/green_apple_bubble.png"));
    ...
    // private WorldTexture TEXTURE = new WorldTexture(ResourceLocation.fromNamespaceAndPath("kasuga_lib", "textures/gui/pixel.png"));
    @Override
...
*/
    ...
    // Moved here from GreenAppleTile: 1.21 exposes the render bounding box on the renderer.
    @Override
    public AABB getRenderBoundingBox(GreenAppleTile tile) {
        return AABB.ofSize(RendererUtil.blockPos2Vec3(tile.getBlockPos()), 5, 5, 5);
    }
}
