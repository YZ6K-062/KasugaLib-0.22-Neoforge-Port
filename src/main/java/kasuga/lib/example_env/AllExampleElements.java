...
public class AllExampleElements {
    ...
    // Declared before greenApple so the block below can reference the tab in its initialiser.
    ...
    // 1.21: CreativeModeTab.TAB_DECORATIONS no longer exists (vanilla tabs are ResourceKeys now),
    // so the example blocks are attached to this library's own test tab instead.
    public static final BlockReg<GreenAppleBlock> greenApple =
            ...
            .defaultBlockItem(ResourceLocation.fromNamespaceAndPath(KasugaLib.MOD_ID, "block/test/green_apple"))
            .stackSize(32)
            .tabTo(tab)
            .submit(REGISTRY);
    ...
    /*
    public static final ModelReg greenAppleModel = new ModelReg("green_apple", ResourceLocation.fromNamespaceAndPath(KasugaLib.MOD_ID, "block/test/green_apple"))
            .submit(REGISTRY);
    ...
    public static final ModelReg wuLingVans = new
            ModelReg("wuling_vans", ResourceLocation.fromNamespaceAndPath(KasugaLib.MOD_ID, "entity/test/wuling/wuling_base"))
            .submit(REGISTRY);
    ...
    public static final FluidReg<ExampleFluid> exampleFluid = new FluidReg<ExampleFluid>("example_fluid")
            ...
            .blockType((fluid, properties) ->
                    new ExampleFluidBlock(fluid.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER)))
            .noLootAndOcclusion()
